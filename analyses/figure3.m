...
%           Results for the Exogenous attention experiment
%
% By:       Michael Jigo
% Edited:   07.01.21
%
...
addpath(genpath('./helperfun'));
   ...
   %% Get subject-level results
      % isolate endo data
         ...
         idx            = find(ismember(params.attntype,'exo')); 
         data           = data(idx);
   ...
   %% Plot
      ...
      figure('name','Exogenous attention','position',[617 165 215 380]);
      ...
      % reaction time
         ...
         legend(leg,{'Neutral' 'Peripheral'},'fontname','arial','fontsize',8,'location','southwest');
