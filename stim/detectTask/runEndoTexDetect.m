...
fixation = 0.5;
cue = 0.3; % changed from 0.07 %%%%CHANGE WAS MADE BECAUSE I WAS NOT GETTING AN ENDO EFFECT
isi = 0.2; % changed from 0.23
...
if task.thistrial.targetPresent
    ...
    c = find(stimulus.tex.texParams.contrast==stimulus.gabor.contrast); % used 29 for Joey
else
...
stimulus.respCue.dispNum = stimulus.respCue.dispNum-1;
